...
<head>
    ...
    <script type="text/javascript">
       ...
       /* function refreshImg() {
            ...
            //img.src = "verifyCode? rnd="+Math.random();//刷新verifyCodeServlet,即验证码
        }
        */
        function ininFunc(){
...
<div class="login_div">
    <form action="G:\\stuManager\src\main\java\Service\Login.java" method="post" onsubmit="return checkForm()">
        <table style="margin:auto;border-collapse:separate; border-spacing:0px 10px;">
            ...
            <tr>
              <td>验证码:</td>
                <td align="left"><input id="verifyCode" type="text" name="verifyCode"  style="width:100px;height:20px;size:5;"/>
                    <img id="Img" src="G:\\stuManager\src\main\java\Service\session\VerifyCode"/><a href="#" style="color:black;font-size:15px;" onclick="refreshImg()">换一张</a>
                </td>
            </tr>
            -->
            <tr>
            ...
            <tr>
                <td><input class="button" type="submit" name="submit" value="登录" href="Login"></td>
